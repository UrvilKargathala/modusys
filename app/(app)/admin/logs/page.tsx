...
const ACTION_LABELS: Record<string, string> = {
  ...
  USER_EMPLOYEE_LINKED: "Linked user to employee",
  USER_EMPLOYEE_UNLINKED: "Unlinked user from employee",
  CUSTOMER_CREATED: "Added a customer",
  CUSTOMER_UPDATED: "Updated a customer",
  CUSTOMER_DELETED: "Deleted a customer",
  ARCHITECT_CREATED: "Added an architect",
  ARCHITECT_UPDATED: "Updated an architect",
  ARCHITECT_DELETED: "Deleted an architect",
  QUOTE_CREATED: "Created a quote",
  QUOTE_UPDATED: "Updated a quote",
  ...
  LEAVE_APPROVED: "Approved a leave",
  LEAVE_REJECTED: "Rejected a leave",
  LEAVE_CANCELLED: "Cancelled a leave",
  CABINET_TYPE_UPDATED: "Updated cabinet types",
...
const ACTION_GROUPS = [
  ...
  { label: "User Management", actions: ["USER_INVITED", "USER_ROLE_CHANGED", "USER_PASSWORD_SET_BY_ADMIN", "USER_PASSWORD_CHANGED_SELF", "USER_DELETED", "USER_EMPLOYEE_LINKED", "USER_EMPLOYEE_UNLINKED"] },
  { label: "Customers", actions: ["CUSTOMER_CREATED", "CUSTOMER_UPDATED", "CUSTOMER_DELETED"] },
  { label: "Architects", actions: ["ARCHITECT_CREATED", "ARCHITECT_UPDATED", "ARCHITECT_DELETED"] },
  { label: "Quotes", actions: ["QUOTE_CREATED", "QUOTE_UPDATED", "QUOTE_DELETED", "QUOTE_STATUS_CHANGED"] },
...
const TARGET_ICONS: Record<string, typeof User> = {
  ...
  TASK: FileText,
  LEAVE: FileText,
  CABINET_TYPE: LayoutTemplate,
  UNIT_TYPE: LayoutTemplate,
  INTEGRATION: Shield,
