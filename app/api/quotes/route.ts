...
export async function POST(req: Request) {
  ...
  const data = {
    ...
    shutterFinishThicknessId: b.shutterFinishThicknessId ?? "",
    shutterFinishRawMaterialId: b.shutterFinishRawMaterialId ?? "",
    shutterFinishInternalColourId: b.shutterFinishInternalColourId ?? "",
    shutterFinishExternalColourId: b.shutterFinishExternalColourId ?? "",
